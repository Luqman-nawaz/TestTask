            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <form action="news" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" name="news_excerpt" class="form-control" placeholder="News Description"/>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                        ...
                        <form action="/albums" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="album_description" class="form-control" placeholder="Album Description"/>
                            <input type="file" name="image" class="form-control"/>
                            <input type="submit" class="btn btn-success" value="Save Album"/>
                        </form>
                </div>
            </div>
        </div>
